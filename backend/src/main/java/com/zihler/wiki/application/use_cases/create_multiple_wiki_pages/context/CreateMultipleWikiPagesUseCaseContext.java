...
public class CreateMultipleWikiPagesUseCaseContext implements UseCaseContext {
    ...
    public static CreateMultipleWikiPagesUseCaseContext initialize(Body body, FindWikiPage findWikiPage, StoreWikiPage storeWikiPage, MultipleWikiPagesPresenter presenter) {
