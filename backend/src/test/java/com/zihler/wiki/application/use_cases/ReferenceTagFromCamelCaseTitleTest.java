...
class ReferenceTagFromCamelCaseTitleTest {
    ...
    void test_create_reference_tag_from_title() {
        ...
        ReferenceTagFromCamelCaseTitle referenceTagFromCamelCaseTitle = ReferenceTagFromCamelCaseTitle.from(camelCaseTitle);

        ReferenceTag actualReferenceTag = referenceTagFromCamelCaseTitle.get();
