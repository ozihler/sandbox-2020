...
class TitleReferenceTagTest {
    ...
    void test_create_reference_tag_from_title() {
        ...
        TitleReferenceTag titleReferenceTag = TitleReferenceTag.from(camelCaseTitle);

        ReferenceTag actualReferenceTag = titleReferenceTag.get();
