...
import {ButtonModule, CodeHighlighterModule, ConfirmDialogModule, DragDropModule, PanelModule, TabViewModule} from 'primeng/primeng';
...
import {WikiPageFormattedBodyComponent} from './wiki/adapter/presentation/wiki-page/wiki-page-formatted-body.component';
...
@NgModule({
  declarations: [
    ...
    WikiPageFormattedBodyComponent
